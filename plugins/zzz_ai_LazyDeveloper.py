    ...
    if AI == True: 
        ...
        if user_id:
            try:
                ...
                footer_credit = "🦋<a href='https://telegram.me/PS_OTT'>• ʀᴇᴘᴏʀᴛ ɪꜱꜱᴜᴇ •</a>══<a href='https://t.me/PS_OTT'>• ᴄᴏɴᴛᴀᴄᴛ ᴍᴀꜱᴛᴇʀ •</a>🦋"
                ...
                print(error)
                await message.reply_text(f'Error aa gya PS Bhaiya 😀\n\n{error}')
    else:
        return
