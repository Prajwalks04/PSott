...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton('🙆🏻 Help 🦾', url=f"https://t.me/PS_OTT_BOT?start=help"),
            ],[
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        try:
            ...
            logger.error("Hey Friend, check once You joined our channel or not...!")
            return
        btn = [
            [
             ...
             [
                InlineKeyboardButton(
                    "🦋 SUBSCRIBE TG Channel 🦋", url='https://t.me/PS_MOVIES11'
                )
            ]
        ]
        ...
        if message.command[1] != "subscribe":
            try:
                ...
                btn.append([InlineKeyboardButton(" 🔄 Try Again", url=f"https://t.me/PS_OTT_BOT?start={message.command[1]}")])
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.answer('♥️ Thank You PSDeveloper ♥️')
